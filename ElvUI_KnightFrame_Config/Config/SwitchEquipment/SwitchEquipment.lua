...
local function SettingTable_EquipmentSet()
	...
	for i = 1, GetNumEquipmentSets() do
		local name, _, _, _, _, _, _, missing = GetEquipmentSetInfo(i)
			...
			args = {
				Primary = {
					...
					name = function()
						...
						return ' '..(E.private.KnightFrame.SwitchEquipment.Enable ~= false and NameColor()..L['Primary']..':|r '..(KF.db.Enable ~= false and E.private.KnightFrame.SwitchEquipment.Enable ~= false and Spec and KF.Table.ClassRole[E.myclass][Spec] and KF.Table.ClassRole[E.myclass][Spec].Color or '') or L['Primary']..':|r ')..(Spec and Spec..(SpecRole == 'TANK' and ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\tank.tga:13:13:1:0|t ' or SpecRole == 'HEALER' and ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\healer.tga:13:13:1:0|t ' or ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\dps.tga:13:13:1:0|t') or L['No Spec'])
					end,
					order = 1,
					desc = '',
					descStyle = 'inline',
				...
				Secondary = {
					...
					name = function()
						...
						return ' '..(E.private.KnightFrame.SwitchEquipment.Enable ~= false and NameColor()..L['Secondary']..':|r '..(KF.db.Enable ~= false and E.private.KnightFrame.SwitchEquipment.Enable ~= false and Spec and KF.Table.ClassRole[E.myclass][Spec] and KF.Table.ClassRole[E.myclass][Spec].Color or '') or L['Secondary']..':|r ')..(Spec and Spec..(SpecRole == 'TANK' and ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\tank.tga:13:13:1:0|t ' or SpecRole == 'HEALER' and ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\healer.tga:13:13:1:0|t ' or ' |TInterface\\AddOns\\ElvUI_KnightFrame\\Media\\Graphics\\dps.tga:13:13:1:0|t') or L['No Spec'])
					end,
					order = 2,
					desc = '',
					descStyle = 'inline',
