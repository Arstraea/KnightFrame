...
elseif KF.Table then
	...
	--------------------------------------------------------------------------------
	KF.Table['SynergyTracker_Filters'] = {
		...
		['AttackSpeed'] = { -- Attack Speed 가속 증가
			...
			[GetSpellInfo(128433)] = L['Serpents']..'('..L['Hunter']..'|r)',											-- Serpent's Swiftness			독사의 신속함
			[GetSpellInfo(128432)] = L['Hyenas']..'('..L['Hunter']..'|r)',												-- Cackling Howl				불쾌한 울음소리
			[GetSpellInfo(55610)] = L['DeathKnight'],																	-- Improved Icy Talons			부정의 오라
		...
		['PrivateBuff'] = { -- Private 개인형
			['MainIcon'] = select(3, GetSpellInfo(53563)),
			[GetSpellInfo(53563)] = L['Paladin']..'('..L['Spec_Paladin_Holy']..')',										-- Beacon of Light				빛의 봉화
		},
		['Critical'] = { -- Critical 크리 5% 증가
			['MainIcon'] = select(3, GetSpellInfo(24932)),
			[GetSpellInfo(116781)] = L['Monk']..'('..L['Spec_Monk_Windwalker']..')',									-- Legacy of the White Tiger	백호의 유산
			...
			[GetSpellInfo(24932)] = L['Druid']..'('..L['Spec_Druid_Feral']..', '..L['Spec_Druid_Guardian']..')',		-- Leader of The Pact			무리의 우두머리
			[GetSpellInfo(126309)] = L['Water Striders']..'('..L['Hunter']..'|r)',										-- Still Water					잔잔한 물
		},
		['AllStats'] = { -- All Stats 능력치 증가
			...
			[GetSpellInfo(117667)] = L['Monk'],																			-- Legacy of The Emperor		황제의 유산
