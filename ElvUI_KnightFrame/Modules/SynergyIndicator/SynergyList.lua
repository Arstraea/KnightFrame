...
Info.SynergyIndicator_Filters = {
	...
	Critical = { -- 극대화
		...
		true,
		{ 160200, 'Hunter' },								-- Lone Wolf: Ferocity of the Raptor	고독한 늑대: 랩터의 흉포함
		true,
	...
	Haste = { -- 가속
		...
		true,
		{ 160203, 'Hunter' },								-- Lone Wolf: Haste of the Hyena		고독한 늑대: 하이에나의 날렵함
		true,
	...
	SpellPower = { -- 주문력
		...
		{ 109773, 'Warlock' },								-- Dark Intent							검은 의도
		true,
		{ 160205, 'Hunter' },								-- Lone Wolf: Wisdom of the Serpent		고독한 늑대: 독사의 지혜
		true,
	...
	Mastery = { -- 특화도
		...
		true,
		{ 160198, 'Hunter' },								-- Lone Wolf: Grace of the Cat			고독한 늑대: 표범의 은총
		true,
	...
	Stamina = { -- 체력
		...
		true,
		{ 160199, 'Hunter' },								-- Lone Wolf: Fortitude of the Bear		고독한 늑대: 곰의 인내력
		true,
