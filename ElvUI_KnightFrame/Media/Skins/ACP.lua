...
elseif KF.UIParent and IsAddOnLoaded('ACP') and KF.db.Skins.ACP ~= false and not IsAddOnLoaded('ElvUI_AddOnSkins') then
--------------------------------------------------------------------------------
--<< KnightFrame : Addon Control Panel Skin									>>--
--------------------------------------------------------------------------------
	...
	S:RegisterSkin('ACP', LoadSkin, true)
end