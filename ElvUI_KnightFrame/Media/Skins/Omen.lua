...
elseif KF.UIParent and IsAddOnLoaded('Omen') and KF.db.Skins.Omen ~= false and not IsAddOnLoaded('ElvUI_AddOnSkins') then
--------------------------------------------------------------------------------
--<< KnightFrame : Omen Skin												>>--
--------------------------------------------------------------------------------
	...
	S:RegisterSkin('Omen', LoadSkin, true)
end