...
elseif KF.UIParent and E.db.KnightFrame.UseProfile == true then
	-- Private
	...
	P['unitframe']['colors']['castColor'] = {b = 1, g = 1, r = 1}
	P['unitframe']['colors']['health'] = {b = 1, g = 1, r = 1}
	P['unitframe']['colors']['health_backdrop'] = {b = 0.07, g = 0.07, r = 0.07}
	P['unitframe']['colors']['tapped'] = { r = 0, g = 0, b = 0}
	P['unitframe']['colors']['disconnected'] = { r = 0.49, g = 0.51, b = 0.07}
	P['unitframe']['colors']['auraBarBuff'] = {b = 1, g = 1, r = 1}
